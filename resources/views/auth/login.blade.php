            ...
            <div class="auth-box p-4 bg-white rounded">
                            ...
                            <form class="form-horizontal mt-3 form-material" id="loginform" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group mb-0 mt-4">
                                    <div class="col-sm-12 justify-content-center d-flex">
                                        <p>Tidak memiliki akun? silahkan untuk <a href="{{ route('register') }}" class="text-info font-weight-medium ms-1">Daftar</a></p>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div id="recoverform">
                    <div class="logo">
                        ...
                        <span class="text-muted">Masukan email yang digunakan saat mendaftar, password akan dikirimkan ke email tersebut.</span>
                    </div>
